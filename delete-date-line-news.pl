...
open REF,"<:encoding(utf8)","merged-20110101-20120207" or die "can't open reference file\n"; ## this file address puts reference translation document##
		$j=0;
		$str1="";
		@arry_r1=();
...
open RESULT,">:encoding(utf8)","merged-20110101-20120207-clear" or die "can't open result file\n"; ## this file address puts reference translation document##
