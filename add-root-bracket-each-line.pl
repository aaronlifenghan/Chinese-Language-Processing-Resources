...
open REF,"<:encoding(utf8)","Store-test-result_GraChineseCTB7-ori_7_smoothing-clear-word" or die "can't open reference file\n"; ## this file address puts reference translation document##
		$j=0;
		$str1="";
		@arry_r1=();
...
open RESULT,">:encoding(utf8)","Store-test-result_GraChineseCTB7-ori_7_smoothing-clear-word-root" or die "can't open result file\n"; ## this file address puts reference translation document##
		for($k=0;$k<$num_of_ref_sentence;$k=$k+1)
			{
				print RESULT "(ROOT".$arry_r1[$k].")"."\n";
